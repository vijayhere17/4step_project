...
import img1 from "/images/ecom/4step1.jpg";
        ...
        <div className="px-6 mt-20 bg-gray-100 rounded-lg">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-6 py-10">
            ...
            <div className="flex flex-col">
              ...
              <p className="font-semibold text-gray-700 mb-2">100% Authentic</p>
            ...
            <div className="flex flex-col">
              ...
              <p className="font-semibold text-gray-700 mb-2">Free Shipping</p>
              <p className="font-semibold text-sm text-gray-500">
            ...
            {/* Easy Returns */}
            <div className="flex flex-col">
              <TbTruckReturn className="text-gray-700 text-2xl mb-4" />
              <p className="font-semibold text-gray-700 mb-2">Easy Returns</p>
              <p className="font-semibold text-sm text-gray-500">
